...
temp =
  readr::read_csv(here::here("data","2003_2006", "demographics", "processed", "subset_C_D_DEMO_ALQ_BMX_DIQ_MCQ_PAQ_PFQ_DSQ_DUQ_translated.csv.gz"),
...
temp_mutated =
  temp %>%
  janitor::clean_names() %>%
  rename(age_in_years_at_screening = age_at_screening_adjudicated_recode,
  ...
  mutate(
    ...
    across(c(education_level_adults_20, marital_status,
...
saveRDS(temp_mutated, here::here("data", "2003_2006", "demographics", "processed", "subset_C_D_tidy.rds"))
